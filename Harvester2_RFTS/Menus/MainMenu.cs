...
namespace Harvester
{
    ...
    public class MainMenu : Menu
    {
        ...
        protected override void LoadContent()
        {
            ...
            //main menu textures
            logoTexture = AssetManager.Instance.FindTexture("main_menu_logo");
            playButtonTexture = AssetManager.Instance.FindTexture("main_menu_play");
            creditsButtonTexture = AssetManager.Instance.FindTexture("main_menu_credits");
            manualButtonTexture = AssetManager.Instance.FindTexture("main_menu_manual");
            backgroundBoxTexture = AssetManager.Instance.FindTexture("main_menu_box");
            backgroundTexture = AssetManager.Instance.FindTexture("main_menu_background");
            //credits menu textures
            creditsBackgroundTexture = AssetManager.Instance.FindTexture("credits_menu_background");
            creditsBackButtonTexture = AssetManager.Instance.FindTexture("main_menu_back_left");
            //manual menu textures
            manualBackgroundTexture = AssetManager.Instance.FindTexture("manual_menu_background");
            manualBackButtonTexture = AssetManager.Instance.FindTexture("main_menu_back_right");
            //up and down button textures
            upButtonTexture = AssetManager.Instance.FindTexture("manual_up_button_temp");
            downButtonTexture = AssetManager.Instance.FindTexture("manual_down_button_temp");
        ...
        public override void Update(GameTime gameTime)
        {
                ...
                menuCounter == GraphicsDevice.Viewport.Width)//can only check for click if menu isn't animating
            {
                ...
                if (playButton.ObjectPosition.Contains(new Point(gameEngine.CurrentMouseState.X, gameEngine.CurrentMouseState.Y)))
                {
                    gameEngine.CurrentState = Gamestate.Gameplay;
                    gameEngine.PrevState = Gamestate.MainMenu;
                ...
                if (creditsButton.ObjectPosition.Contains(new Point(gameEngine.CurrentMouseState.X, gameEngine.CurrentMouseState.Y)))
                {
                ...
                if (creditsBackButton.ObjectPosition.Contains(new Point(gameEngine.CurrentMouseState.X, gameEngine.CurrentMouseState.Y)))
                {
                    currentState = MainMenuState.MainMenu;
                ...
                if (manualButton.ObjectPosition.Contains(new Point(gameEngine.CurrentMouseState.X, gameEngine.CurrentMouseState.Y)))
                {
                ...
                if (manualBackButton.ObjectPosition.Contains(new Point(gameEngine.CurrentMouseState.X, gameEngine.CurrentMouseState.Y)))
                {
                        currentState = MainMenuState.MainMenu;
