...
namespace Harvester
{
    ...
    public class GamePause : Menu
    {
        ...
        protected override void LoadContent()
        {
            ...
            title = AssetMgr.Inst().TextureDic["pause_menu_title_texture"];
            pauseButtonTexture = AssetMgr.Inst().TextureDic["pause_menu_resume_button_texture"];
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                //resume button
                if (resumeButton.ObjectPosition.Contains(new Point(gameRef.CurrentMouseState.X, gameRef.CurrentMouseState.Y)))
                {
                    gameRef.CurrentState = Gamestate.Gameplay;
                    //gameRef.PrevState = Gamestate.GamePause;
                }
                //quit button
                if (quitButton.ObjectPosition.Contains(new Point(gameRef.CurrentMouseState.X, gameRef.CurrentMouseState.Y)))
                {
                    ...
                    //gameRef.PrevState = Gamestate.GameOver;//set to gameover because we skipped it
