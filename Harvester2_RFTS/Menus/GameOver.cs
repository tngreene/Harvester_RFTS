...
namespace Harvester
{
    ...
    class GameOver : Menu
    {
        ...
        {
            //load textures
            background = AssetMgr.Inst().TextureDic["game_over_menu_background"];
            title = AssetMgr.Inst().TextureDic["game_over_menu_title"];
            restartButtonTexture = AssetMgr.Inst().TextureDic["game_over_menu_restart_button_texture"];
            quitButtonTexture = AssetMgr.Inst().TextureDic["game_over_menu_quit_button_texture"];
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                //restart button
                if (restartButton.ObjectPosition.Contains(new Point(gameRef.CurrentMouseState.X, gameRef.CurrentMouseState.Y)))
                {
                ...
                //quit button
                if (quitButton.ObjectPosition.Contains(new Point(gameRef.CurrentMouseState.X, gameRef.CurrentMouseState.Y)))
                {
                    gameRef.GameplayState = GameplayState.LevelOne;
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            string scoreString = "Total Score = " + PlayerMgr.Inst().Score;
