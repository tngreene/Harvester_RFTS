...
namespace Harvester
{
    public class PowerUpBar : GameObject
    {
            ...
            : base(rect, texture)
        {
            ...
            blackholePowerUpIcon = AssetManager.Instance.FindTexture("blackhole_icon");
            invincibilityPowerUpIcon = AssetManager.Instance.FindTexture("invincibility_icon");
            doubleDamagePowerUpIcon = AssetManager.Instance.FindTexture("double_damage_icon");
        }
        #endregion
