...
namespace Harvester
{
    public class ImperialBoss : Enemy
    {
        ...
        private LevelThree l3; //ref to level for spawning enemies
        ...
        public ImperialBoss(Rectangle objPos, Texture2D objTexture, double objSpeed, int objHealth, Texture2D bulletTexture, double damage, LevelThree l3)
            : base(objPos, objTexture, objSpeed, objHealth, bulletTexture, damage)
        {
            hasHitSide = false;
            hasHitUp = false;

            fireSound = AssetManager.Instance.FindSound("imperial_laser_fire");
        ...
        {
            //spawn fighters
            EnemyFighter e1 = (EnemyFighter)SpawnManager.Instance.SpawnSingle(100, -1, -1, null);
            EnemyFighter e2 = (EnemyFighter)SpawnManager.Instance.SpawnSingle(100, -1, -1, null);
